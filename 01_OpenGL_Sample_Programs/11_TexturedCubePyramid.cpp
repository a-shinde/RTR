...
void Initialize()
{
    ...
    LoadGLTextures(&textureStone, MAKEINTRESOURCE(IDBITMAP_STONE));
    LoadGLTextures(&textureKundli, MAKEINTRESOURCE(IDBITMAP_KUNDALI));
...
void Display()
{
    ...
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, textureKundli);
    glUniform1i(texture0Sampler_uniform, 0);
