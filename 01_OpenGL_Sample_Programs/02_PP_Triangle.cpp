...
void Initialize()
{
    ...
    orthoProjectionMatrix = mat4::identity();
...
void initializeData()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangleCord), triangleCord, GL_STATIC_DRAW);
...
void resize(int width, int height)
{
    ...
    if (width <= height)
        orthoProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0f * (height / width)), (100.0f * (height / width)), -100.0f, 100.0f);
     else
        orthoProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0f * (width / height)), (100.0f * (width / height)), -100.0f, 100.0f);
...
void Display()
{
    ...
    mvpMatrix = orthoProjectionMatrix * modelViewMatrix;
